...
PARAM([string]$packageSourceFolder, [string]$packageOutputFolder, [string]$language, [string]$timestampServer="", [string]$pfxFileName="")
...
{
    show-ErrorMessage "You must specify the package source folder."
    return
}
...
$packageOutputFolder = (Resolve-Path $packageOutputFolder).Path
$packageCompiledFolder = Get-CompiledPackfolder $packageOutputFolder
$cabFileOutputPath = Get-DiagnostiCabfolder $packageOutputFolder
if([string]::IsNullOrEmpty($packageCompiledFolder) -or [string]::IsNullOrEmpty($cabFileOutputPath))
{
    return
}

.\CompileDiagPack.ps1 $packageSourceFolder $packageCompiledFolder $language $timestampServer $pfxFileName

.\CabDiagPack.ps1 $packageCompiledFolder $cabFileOutputPath $timestampServer $pfxFileName

# SIG # Begin signature block
# MIIa+wYJKoZIhvcNAQcCoIIa7DCCGugCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU5EynGYz1psebdJzwdZtaSxRu
# 4aegghXYMIIEhTCCA22gAwIBAgIKYQX3HgAAAAAAMjANBgkqhkiG9w0BAQUFADB5
...
# KwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUoc0lUHJtbz5h1au5IqvU9x1njMow
...
# hkiG9w0BAQEFAASCAQA82EpvJbE+33NzpDnh7hJgiT/p74IEMEu7G+YUI3VVUWYs
# IkQpU1RQtPqgvDJnwdBNOnjm4fZbIC9qcmHVNvh0+cDxRWrDnRdtjLASSHQ9DxL0
# jtwZddakOrP23XzB0c5ByoEz/aJAjF7nO2E/nKQH7y+ZLuIQl1PU1/v/qeuEssPm
# J9NDQkgFd5hHncHhOt//QHHHbX4qhghp5aXmRtIBT8wkbWjB45K6/ASzJfmkoxWY
# juEqwhnOZv8bu0T8bLAbJZsDdnhFE+DixebnRYgRh0r4H3ZJ0VGxoMJdAOdst6tG
# bStU8gOsJ8nBVpsKD0IhxivkAvZBvoZRuwQhleieoYICHTCCAhkGCSqGSIb3DQEJ
...
# hvcNAQkFMQ8XDTA5MTAyMzA1MjA0MlowIwYJKoZIhvcNAQkEMRYEFDvP5x7MLMNw
# 9bXGDVq/P9tbhS5pMA0GCSqGSIb3DQEBBQUABIIBAAkoUIcOxhbfMgzPljdeYa7U
# HjKmNw7TMiHHOT3Q3JXayiih13mU+1YlImt/BeyZeo0LKJ0UCqGMiKGzkAvMo1ZZ
# IBGZq9m3ZBIg+KSpmhlA9gkFC5rGBiNyEY/5S65G4TNS0lPJ4a7JRqn24AkQe931
# tHQd4WQvRYCPLLuyhNC5rO85RTuw/3DRsa8e0/JCTEMvD+nr6ZR/p5E6haSSSxNQ
# SKo7uZlz1ONBOS6UAMWyTZCY1PjPn1ZobCYQX6NsGdY6p7dYxYi3Xr4DdG5dDhbX
# 50wuW2DtdtY63Pl1+dyTcQqy6Cyh95Rwug5FBg88ygop/BXt7KBzVzuNMEGKnKo=
